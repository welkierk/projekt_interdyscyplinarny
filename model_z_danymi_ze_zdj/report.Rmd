...
Top gminas in the selected area are presented in the table. Those locations are marked on the map below. If you want to check where the marker points, click on it.
...
Following plot shows how different factors are used by model to create final result. The last plot presents variable importance in the prediction model.
...
break_down <- predict_parts(explainer, new_observation = data[index,-c(1:3)]) # wyciągnąć z data tą obserwację co naj 
